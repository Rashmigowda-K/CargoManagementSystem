...
namespace CargoManagementSystem
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<CargoDbContext>(options => options.UseSqlServer(connectionStr));
            services.AddControllers();
            services.AddTransient<ICustRepo, CustRepo>();
            services.AddTransient<CargoService, CargoService>();
        }
